...
export default function EditarProducto() {
  ...
  const cargarProducto = async (productoId: number) => {
    try {
      setLoading(true);
      const data = await getProductoNombreById(productoId);

      setFormData({
        vnombre_producto: data.vnombre_producto,
  ...
  const handleSubmit = async () => {
    ...
    try {
      setSaving(true);
      await actualizarProductoNombre(Number(id), formData);
      setModalExito({
        visible: true,
  ...
  if (loading) {
    return <LoadingSpinner message="Cargando nombre de producto..." />;
  }
        ...
        <View style={styles.pageHeaderContainer}>
          <View style={styles.pageHeader}>
            ...
            <View style={styles.headerText}>
              <Text style={styles.title}>Editar Nombre de Producto</Text>
              <Text style={styles.subtitle}>
                Modifique la información del nombre de producto
              </Text>
            </View>
          </View>
        </View>
